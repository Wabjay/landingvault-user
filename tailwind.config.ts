  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'buttonDefault': '0px 0.5px 0px 0px rgba(3, 7, 18, 0.16), 0px 0.5px 0px 0px rgba(3, 7, 18, 0.16)',
        'buttonFocus': '0px 0px 0px 3px rgba(2, 117, 255, 0.20)',
        'supportButton': '0px 1.75px 0px 0px rgba(255, 255, 255, 0.16) inset, 0px 0.25px 0px 0px rgba(3, 7, 18, 0.16), 0px 0.5px 0px 0px rgba(3, 7, 18, 0.16)',
        'shareCard': '0px 0px 0px 1px rgba(3, 7, 18, 0.08), 0px 1px 2px -1px rgba(3, 7, 18, 0.08), 0px 2px 4px 0px rgba(3, 7, 18, 0.04)',
        'shareLinks': '0px 0.25px 0px 0px rgba(3, 7, 18, 0.16), 0px 0.5px 0px 0px rgba(3, 7, 18, 0.16)',
      },
      backgroundImage: {
