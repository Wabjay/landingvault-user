...
setPageName(pageName)
  ...
  <div className="laptop:h-full flex flex-col gap-6 text-left laptop:col-span-4">
    ...
    Explore top <span>{pageName.toLowerCase()}</span> page design inspiration  on Landingvault. Get inspired with curated, high-quality <span>{pageName.toLowerCase()}</span> examples.
    </p>
  </div>
